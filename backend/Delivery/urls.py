...
from .views import RequestDelivery,DeliveryList,DeliverySearch,AcceptDelivery,UpdateTime,DeliveryDetailView,Courier_details,Rate_courier,Courier_completed,courier_currlocation,Pickedup_StatusUpdate,verify_otp,CancelDelivery,estpickuptime,estdropofftime
...
urlpatterns = [
    ...
    path('est_pickuptime/update/',estpickuptime,name='estpickuptime_update'),
    path('est_dropofftime/update/',estdropofftime,name='estpickuptime_update'),
