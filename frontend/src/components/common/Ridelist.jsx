...
function Ridelist({ rides }) {
    ...
    const ridesPerPage = 6; // Number of deliveries per page
                    ...
                    <TableBody>
                        {currentrides.map((ride, index) => (
                            ...
                            <TableRow key={ride.id}>
                                ...
                                <TableCell className="p-4">{ride.route.starting_point}, </TableCell>
                                <TableCell className="p-4">{ride.route.endpoint}</TableCell>
                                <TableCell className="p-4">{ride.total_seats}</TableCell>
