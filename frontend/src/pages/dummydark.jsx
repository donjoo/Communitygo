...
import { ChevronRight, Package, Car, Users, Clock, MapPin, Shield, Sun, Moon } from 'lucide-react'
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <div className="hidden md:flex space-x-6">
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 transition duration-300">Home</a>
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 transition duration-300">How It Works</a>
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 transition duration-300">About Us</a>
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-orange-500 dark:hover:text-orange-400 transition duration-300">Contact</a>
              </div>
              <button
      ...
      <main>
        ...
        <section className="py-20 bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-12">How CommunityGo Works</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {features.map((feature, index) => (
                <div key={index} className="bg-white dark:bg-gray-700 rounded-lg shadow-lg p-8 text-center transition duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1">
        ...
        <section className="bg-orange-100 dark:bg-gray-700 py-20 transition-colors duration-300">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-12">Community Voices</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white dark:bg-gray-600 rounded-lg shadow-lg p-8 transition duration-300 ease-in-out hover:shadow-xl">
        ...
        <section className="bg-gray-800 dark:bg-gray-900 text-white py-20 transition-colors duration-300">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="space-x-6">
              ...
              <button className="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out hover:bg-white hover:text-gray-800 dark:hover:text-gray-900 hover:scale-105 transform">
                Learn More
              </button>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 dark:bg-black text-white py-10 transition-colors duration-300">
        <div className="container mx-auto px-6">
